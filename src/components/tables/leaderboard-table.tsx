  ...
  const sortedData = [...data].sort((a, b) => {
    ...
    switch (sortKey) {
      ...
      case 'convoRate':
        ...
        break
      default:
        aValue = a[sortKey as keyof LeaderboardEntry] as number
        bValue = b[sortKey as keyof LeaderboardEntry] as number
    }
            ...
            <TableHeader>
              <TableRow>
                ...
                {(visibleMetrics.includes('deals_closed') || visibleMetrics.length === 0) && (
                  <TableHead className="text-right">
                    <SortableHeader label="Deals" sortKey="deals_closed" />
                  </TableHead>
                )}
